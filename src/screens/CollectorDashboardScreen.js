// src/screens/CollectorDashboardScreen.js
...
const CollectorDashboardScreen = ({ navigation }) => {
  ...
  const menuItems = [
    ...
    { icon: 'cash', title: 'Collect Payment', screen: null, color: COLORS.success },
    { icon: 'list', title: 'My Collections', screen: null, color: COLORS.warning },
    { icon: 'document-text', title: 'Reports', screen: null, color: COLORS.danger },
  ];
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.welcomeCard}>
          ...
          <Text style={styles.welcomeSubtitle}>
            {user?.collector_name || 'Collector Panel'}
          </Text>
        </View>
